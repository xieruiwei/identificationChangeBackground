...
def init():
    readPath = '/usr/java/tomcat/webapps/identificationChangeBackground/bodyanalysisPath'+sys.argv[1]+'.png'
    writePath = '/usr/java/tomcat/webapps/identificationChangeBackground/beauty'+sys.argv[1]+'.png'
    print readPath
    print writePath
...
#    cv2.imshow('image4', blur4)
    ...
    cv2.waitKey(0)
    cv2.imwrite(writePath, blur3)
#    cv2.imwrite('/usr/java/tomcat/webapps/identificationChangeBackground/img/result2.png', blur4)
